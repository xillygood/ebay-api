...
class eBaySession
{
	...
	*/
	public function sendHttpRequest($requestBody,$off=0)
	{
		//build eBay headers using variables passed via constructor
		switch ($off) {
			case 1: $headers = $this->buildEbayFileTransferHeaders();	break;
			default:$headers = $this->buildEbayHeaders();	break;
		}
		//echo $headers."<br/>";
		...
		curl_setopt($connection, CURLOPT_TIMEOUT, 60000);
